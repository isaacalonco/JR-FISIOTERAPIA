 ...
 * Memorizado por requisição via React cache() para evitar chamadas duplicadas de rede entre Layout e Páginas.
 */
export const getCurrentUserSession = cache(async (): Promise<SessionContext | null> => {
  try {

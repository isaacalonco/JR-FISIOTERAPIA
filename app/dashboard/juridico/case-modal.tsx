...
import { Plus, X, CheckCircle2, AlertCircle, Scale } from "lucide-react";
...
export default function NewCaseModal({ patients }: CaseModalProps) {
          ...
          <div className="relative z-10 w-full max-w-xl max-h-[85vh] flex flex-col bg-[#010F25] border border-[#C1801F]/35 rounded-3xl shadow-2xl overflow-hidden text-[#E3DCBE]">
            <div className="p-5 sm:p-6 border-b border-[#011733] flex items-center justify-between shrink-0 bg-[#010F25]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-bold text-white">Cadastrar Processo / Caso Jurídico</h2>
                  <p className="text-xs text-[#E3DCBE]/70">Registro com rastreamento e vínculo com paciente.</p>
                </div>
              </div>
              <button
                type="button"
              ...
              <form action={formAction} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="block font-semibold text-[#E3DCBE]/80">Nº do Processo / Registro *</label>
                    <input
                      type="text"
                      name="case_number"
                      required
                      placeholder="Ex: PROC-2026-0042"
                      className="w-full p-2.5 bg-[#000A1B]/80 border border-[#011733] focus:border-[#E5A838] rounded-xl text-[#E3DCBE] focus:outline-none"
                    />
                  </div>

                  <div className="space-y-1">
                    <label className="block font-semibold text-[#E3DCBE]/80">Tipo de Caso *</label>
                    <select
                      name="case_type"
                      required
                      className="w-full p-2.5 bg-[#000A1B]/80 border border-[#011733] focus:border-[#E5A838] rounded-xl text-[#E3DCBE] focus:outline-none"
                ...
                <div className="space-y-1">
                  <label className="block font-semibold text-[#E3DCBE]/80">Título / Assunto *</label>
                  <input
                    type="text"
                    name="title"
                    required
                    placeholder="Ex: Defesa de responsabilidade técnica em reembolso"
                    className="w-full p-2.5 bg-[#000A1B]/80 border border-[#011733] focus:border-[#E5A838] rounded-xl text-[#E3DCBE] focus:outline-none"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="block font-semibold text-[#E3DCBE]/80">Paciente Vinculado (Opcional)</label>
                    <select
                      name="patient_id"
                      className="w-full p-2.5 bg-[#000A1B]/80 border border-[#011733] focus:border-[#E5A838] rounded-xl text-[#E3DCBE] focus:outline-none"
                    >
                  ...
                  <div className="space-y-1">
                    <label className="block font-semibold text-[#E3DCBE]/80">Advogado Responsável</label>
                    <input
                      type="text"
                      name="lawyer_name"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    <label className="block font-semibold text-[#E3DCBE]/80">Data Limite / Prazo</label>
                    <input
                      type="date"
                      name="due_date"
                      className="w-full p-2.5 bg-[#000A1B]/80 border border-[#011733] focus:border-[#E5A838] rounded-xl text-[#E3DCBE] focus:outline-none"
                ...
                <div className="space-y-1">
                  <label className="block font-semibold text-[#E3DCBE]/80">Observações / Detalhes</label>
                  <textarea
                    name="description"
                    rows={3}
                    placeholder="Descrição sumária do andamento ou objeto da ação..."
                    className="w-full p-2.5 bg-[#000A1B]/80 border border-[#011733] focus:border-[#E5A838] rounded-xl text-[#E3DCBE] focus:outline-none resize-none"
                  />
                </div>
                ...
                <div className="pt-4 border-t border-[#011733] flex justify-end gap-3">
                  ...
                  >
                    {isPending ? "Salvando..." : "Salvar Caso"}
                  </button>
                </div>
              </form>
            </div>
